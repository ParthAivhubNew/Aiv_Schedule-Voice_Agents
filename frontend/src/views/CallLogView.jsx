                ...
                {isExpanded && (
                  <div style={{ marginTop: 18, paddingTop: 16, borderTop: `1px solid ${C.borderLight}` }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                      ...
                      <button
                        onClick={(evt) => handleCopyTranscript(evt, log)}
                        style={{
                          display: "inline-flex",
                          alignItems: "center",
                          gap: 6,
                          background: copiedId === log.id ? "#DCFCE7" : "#FFFFFF",
                          border: `1px solid ${copiedId === log.id ? "#86EFAC" : C.border}`,
                          borderRadius: 7,
                          padding: "5px 10px",
                          fontFamily: FONT_BODY,
                          fontSize: 11.5,
                          fontWeight: 600,
                          color: copiedId === log.id ? "#166534" : C.slate,
                          cursor: "pointer",
                          transition: "all 0.15s ease"
                        }}
                      >
                        {copiedId === log.id ? "✅ Copied!" : "📋 Copy Transcript"}
                      </button>
                    </div>
